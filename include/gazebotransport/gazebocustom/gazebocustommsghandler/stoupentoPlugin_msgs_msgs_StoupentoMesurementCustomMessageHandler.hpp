...
#ifndef STOUPENTOPLUGIN_MSGS_MSGS_STOUPENTOMESUREMENTCUSTOMMESSAGEHANDLER_HPP
#define STOUPENTOPLUGIN_MSGS_MSGS_STOUPENTOMESUREMENTCUSTOMMESSAGEHANDLER_HPP
...
namespace robotics {
    namespace gazebotransport {
        typedef const boost::shared_ptr<const stoupentoPlugin_msgs::msgs::StoupentoMesurement> stoupentoPlugin_msgs_msgs_StoupentoMesurementCustomPtr;
         ...
         * */
        class stoupentoPlugin_msgs_msgs_StoupentoMesurementSubscriber {
        public:
            /// Constructor
            /*
             ...
             */
            explicit stoupentoPlugin_msgs_msgs_StoupentoMesurementSubscriber(std::string const& topicName)
            ...
            /// Destructor
            virtual ~stoupentoPlugin_msgs_msgs_StoupentoMesurementSubscriber() {
            }
            
            // subscriber callback which subscribe custom message from specific topic
            // and stores in the custom message container
            void OnUpdate(robotics::gazebotransport::stoupentoPlugin_msgs_msgs_StoupentoMesurementCustomPtr& _msg) {
                {
            ...
            void InitImpl(gazebo::transport::NodePtr node) {
                if (!m_subscriberPtr) {
                    m_subscriberPtr = node->Subscribe(m_topicName, &stoupentoPlugin_msgs_msgs_StoupentoMesurementSubscriber::OnUpdate, this);
                }
            }
         ...
         * The stoupentoPlugin_msgs_msgs_StoupentoMesurementCustomMessageHandler initialize gazebo publisher, subscriber.
         * Further, it publish and subscribe custom message on/from gazebo.
         * It can support multiple topics of same message type.
         * */
        class stoupentoPlugin_msgs_msgs_StoupentoMesurementCustomMessageHandler : public CustomMsgHandler {
        public:
            /// Constructor
            /*
			@param node                     Gazebo transport node pointer
			@param customContainer          Custom message storage instance
             */
            explicit stoupentoPlugin_msgs_msgs_StoupentoMesurementCustomMessageHandler(gazebo::transport::NodePtr node);
            
            /// Destructor
            ~stoupentoPlugin_msgs_msgs_StoupentoMesurementCustomMessageHandler();
            ...
            std::pair<std::shared_ptr<stoupentoPlugin_msgs_msgs_StoupentoMesurementSubscriber>, bool> insert(
            ...
            std::shared_ptr<stoupentoPlugin_msgs_msgs_StoupentoMesurementSubscriber> find(std::string const& topic);
        ...
        private:
            ...
            std::map<std::string, std::shared_ptr<stoupentoPlugin_msgs_msgs_StoupentoMesurementSubscriber>> m_subscriberPtrMap;
